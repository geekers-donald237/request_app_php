                    ...
                    //passed
                        ...
                        //     //Free result1
                            ...
                            foreach ($emails as $mail) {
                              ...
                              if (strtolower($email) == strtolower($mail['AdresseEmail']) && $password == $mail['MdpEnseignant']) {
                                session_start();  
                                $_SESSION['usermail'] = $mail['AdresseEmail'];
            ...
            <div class="row h-100 justify-content-between align-items-center g-3">
                ...
                <div class="col-lg-6 col-md shadow bg-light border">
                    ...
                    action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>">
                        ...
                        <div class="form-goup align-center justify-content-center d-flex">
                            <button type="submit" name="submit" class="btn btn-primary " style="width: 40vh;">Submit</button>
                        </div>
                      </form>
                </div>
            </div>
